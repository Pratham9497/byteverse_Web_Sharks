...
<body>
    ...
    <section class="comment-box">
        <div class="user">
            <div class="user-pic" style="background-color: grey;">&nbsp;&nbsp;&nbsp;<?php echo ucfirst($_SESSION['username'][0]); ?></div>
            <div class="name"></div>
        </div>
        ...
        <a href="doubts2.php"><button type="button" class="btn btn-info">Want to answer the query</button></a>
</section>
 <!--===========================start footer=======================-->
 <footer class="footer">
